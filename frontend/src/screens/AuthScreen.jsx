...
export default function AuthScreen({ onGoogleSignIn, onSendOtp, onVerifyOtp, theme }) {
  ...
  return (
    <div className={styles.screen}>
      ...
      <div className={styles.card}>
        ...
        {step === 'home' && (
          <>
            ...
            <p className={styles.cardBody}>
              Your progress and stats are saved to your account and sync across devices.
            </p>
            ...
            <button
              ...
              onClick={() => { setStep('otp-email'); setError(null); }}
              disabled={loading}
            >
        ...
        {step === 'otp-email' && (
          <>
            <button className={styles.backBtn} onClick={() => { setStep('home'); setError(null); }}>
              ← Back
            </button>
        ...
        {step === 'otp-code' && (
          <>
            <button className={styles.backBtn} onClick={() => { setStep('otp-email'); setError(null); setCode(''); }}>
              ← Back
            </button>
